...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("ConversationsObjectPageObjectPage journey");

        opaTest("Navigate to ConversationsObjectPageObjectPage", function (Given, When, Then) {
            Given.iStartMyApp();
            ...
            Then.onTheIncidentsObjectPageGenerated.onTable({ property: "conversations" }).iCheckRows();
            When.onTheIncidentsObjectPageGenerated.onTable({ property: "conversations" }).iPressRow(0);

            Then.onTheConversationsObjectPageGenerated.iSeeThisPage();
        });
